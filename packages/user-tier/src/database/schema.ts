...
// Task: 更新数据库Schema，包含M6核心5张表：users、organizations、quota_usage、subscriptions、audit_logs
...
import { CREATE_TABLES_SQL_V2, CREATE_INDEXES_SQL_V2 } from './models.js';

/**
 * 创建数据库表的SQL语句
 * 
 * 注意：保留旧表以保证后向兼容，同时添加M6核心5张表
 */
export const CREATE_TABLES_SQL = {
  // ==================== M6核心表 ====================
  
  ...CREATE_TABLES_SQL_V2,
...
export const CREATE_INDEXES_SQL = [
  // M6核心表索引
  ...CREATE_INDEXES_SQL_V2,
  
  // 旧版表索引（保留兼容）
  'CREATE INDEX IF NOT EXISTS idx_users_old_email ON users_old(email)',
  'CREATE INDEX IF NOT EXISTS idx_users_old_organization ON users_old(organization_id)',
  'CREATE INDEX IF NOT EXISTS idx_subscriptions_old_user ON subscriptions_old(user_id)',
