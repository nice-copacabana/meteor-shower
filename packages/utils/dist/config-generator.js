...
export class ConfigGenerator {
     ...
     * @returns 渲染后的内容
     */
    async renderTemplateFile(tool, templateFileName, variables) {
        // 构建模板文件路径
        const templatePath = path.join(process.cwd(), 'packages/templates/configs', tool, templateFileName);
        try {
            // 读取模板文件
     ...
     * @returns 占位符内容
     */
    generateFallbackContent(tool, templateFileName, variables) {
